  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (isForgotPassword) {
        ...
        // Industry standard validation for full name
        ...
        <div className="p-stack-lg md:p-10">
          ...
          <div className="mt-stack-lg text-center">
            <p className="text-body-sm font-body-sm text-on-surface-variant">
              ...
              <button
                type="button"
                onClick={() => switchTab(isForgotPassword ? true : !isLogin)}
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <Suspense fallback={
        <div className="w-full max-w-md flex flex-col items-center">
          <img src="/logo.svg" alt="MeetSense Logo" className="h-14 object-contain mb-8 animate-pulse" />
          <div className="w-full h-[500px] bg-surface-container-lowest border border-outline-variant rounded-xl shadow-sm animate-pulse"></div>
        </div>
      }>
        <LoginContent />
      </Suspense>
